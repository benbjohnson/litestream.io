...
```sh
wget https://github.com/benbjohnson/litestream/releases/download/v0.3.10/litestream-v0.3.10-linux-amd64.deb
```

Then install it using `dpkg`:

```sh
sudo dpkg -i litestream-v0.3.10-linux-amd64.deb
```
