...
{{< alert icon="⚠️" text="Age encryption is not available in Litestream v0.5.x. Attempting to configure `age` will cause a configuration error. Encryption support is planned for a future release. For v0.3.x encryption documentation, refer to the v0.3 docs." >}}
